...
import com.example.android.politicalpreparedness.core.util.PermissionUtils
import com.example.android.politicalpreparedness.data.source.remote.models.Address
    ...
    private fun setupUI() {
        ...
        binding.spinnerStates.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onNothingSelected(parent: AdapterView<*>?) {
                _viewModel.updateState(binding.spinnerStates.selectedItem as String)
            }
